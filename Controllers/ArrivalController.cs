...
namespace ParkApi.Controllers
{
    ...
    public class ArrivalController : ControllerBase
    {
        ...
        public ArrivalController(IReservationRepository reservationRepository)
        {
        ...
        public async Task<ActionResult<List<Reservation>>> Get([FromQuery]ReservationQuery query) {
            return await _reservationRepository.GetAllArrivalsAsync(query);
        }
    ...
    public async Task<IActionResult> Put(string id, [FromBody]Reservation reservation)
    {
        ...
        await _reservationRepository.UpdateArrival(reservationFromDb);
